...
router.get("/getallprojectsbyid/:id",protect,projectController.getAllProjectsById);

router.get("/getprojectbyid/:uid/:pid",protect,projectController.getProjectById);

router.get("/getallprojectbyid-pagination/:page",protect,projectController.getAllProjectsPagination);

router.get("/getallprojectsbyuserid/:id",projectController.getAllProjectsByUserId);
